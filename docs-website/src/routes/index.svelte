...
<div class="wrapper">
	<div class="content" in:fly={{ y: 25, duration: 1000 }}>
		<nav class="card">
			<ul class="list">
				<li>
					<a class="list__link" href="/element-enhancer/introduction">Docs</a>
				</li>
				<!-- TODO: Replace links with actual path when pages are created -->
				<li><a class="list__link" href="#resources">Resources</a></li>
				<li><a class="list__link" href="#packages">Package</a></li>
		...
		<a
			class="github-link"
			href="https://github.com/jKm00/element-enhancer"
			target="_blank"
		>
			GitHub
